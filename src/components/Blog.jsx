...
const Blogs = () => {
  ...
  const data = [
   
    {
      ...
      image: "static/images/goal setting.jpg",
    ...
    },
    {
      ...
      image: "static/images/track spendings.jpg",
    ...
    },
    {
      ...
      image: "static/images/Categorize expenses.jpg",
    ...
    },
    {
      ...
      image: "static/images/analyze spending patterns.webp",
    ...
    },
    {
      ...
      image: "static/images/create budget.webp",
    ...
    },
    {
      ...
      image: "static/images/track progress.webp",
    ...
    <div className='grid grid-cols-1 sn:grid-cols-2 lg:grid-cols-3 gap-4 mx-20 mt-8 bg-white rounded-lg shadow-md p-8'>
      {data.map((blog) => (
        <><div key={blog.id} className='border p-4'>
          ...
          <div><img static={blog.image} alt={{ width: 100, height: 200 }} /></div>
